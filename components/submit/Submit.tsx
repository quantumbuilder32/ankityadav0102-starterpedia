                ...
                <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, display: "grid", justifyItems: "center", alignItems: "center", backgroundColor: "rgba(0,0,0,0.05)" }} onClick={() => wantsToSubmitSet(false)}>
                    <div style={{ width: 'min(100%, 400px)', maxHeight: "70vh", overflow: "auto", backgroundColor: "#fff", display: "grid", gap: "1rem", alignContent: "flex-start", padding: "2rem", borderTopLeftRadius: "2rem", cursor: "default" }} onClick={(e) => e.stopPropagation()}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                            ...
                            <svg style={{ width: "1.5rem" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" onClick={() => { wantsToSubmitSet(false) }} /></svg>
                        </div>
